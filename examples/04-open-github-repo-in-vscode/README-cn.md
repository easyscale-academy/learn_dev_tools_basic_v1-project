...
>
> **关于下面的快捷键:** 这门课默认你在用 Mac, 下面出现的快捷键都是 Mac 的写法. 如果你在 Windows 或者 GitHub Codespace 的网页版这些环境里, 快捷键会不一样, 按了没反应很正常. 遇到这种情况, 直接告诉你的 AI agent 你现在用的是哪个环境, Windows, Mac, 还是 GitHub Codespace, 让它告诉你对应的快捷键.
...
当你真的需要写代码时, 比如以后学 Python, VS Code 只是你已经熟悉的工具, 不是新的挑战. 你已经具备了工作流里人的那一半: 打开项目, 找到文件, 拿到路径, 用集成终端. 下一个 Task 会正式介绍工作流里 AI 的那一半, coding agent, 说清楚它到底是什么, 以及怎么补齐注册账号和基本操作这两块前置技能.
